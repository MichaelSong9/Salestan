...
public partial class AdminBlog : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ali.insertAdminLog(Convert.ToInt32(Session["UserId"]), 2200, 0, "0");
        }

        DataTable dt = new DataTable();
        DataSet ds = new DataSet();
        SqlConnection sqlConn = new SqlConnection(ConfigurationManager.ConnectionStrings["ShopConnectionString"].ConnectionString);
        SqlCommand sqlCmd = new SqlCommand("sp_commentsBlogPendingCount", sqlConn);
    ...
    protected void ImageButtonAdd_Click(object sender, ImageClickEventArgs e)
    {
        ...
        else
        {
            ...
            //Brief
            StringBuilder sbBrief = new StringBuilder(HttpUtility.HtmlEncode(TextBoxBrief.Text));
            sbBrief.Replace("&lt;", "<");
            sbBrief.Replace("&gt;", ">");
            string brief = sbBrief.ToString();
            //Body
            StringBuilder sbBody = new StringBuilder(HttpUtility.HtmlEncode(TextBoxBody.Text));
            sbBody.Replace("&lt;", "<");
            sbBody.Replace("&gt;", ">");
            ...
            SqlCommand sqlCmd = new SqlCommand("sp_blogAdd", sqlConn);
            sqlCmd.CommandType = CommandType.StoredProcedure;
            ...
            sqlCmd.Parameters.Add("@Brief", SqlDbType.NVarChar).Value = brief;
            sqlCmd.Parameters.Add("@Body", SqlDbType.NVarChar).Value = body;
            ...
            LabelAddMessage.Text = "مطلب با مشخصات وارد شده اضافه گردید.";
    ...
    protected void ImageButtonCategoryAdd_Click(object sender, ImageClickEventArgs e)
    {
        ...
        SqlDataAdapter sda = new SqlDataAdapter("sp_blogCategoryAddCheckExists", sqlConn);
        ...
        {
            SqlCommand sqlCmd = new SqlCommand("sp_blogCategoryAdd", sqlConn);
            sqlCmd.CommandType = CommandType.StoredProcedure;
