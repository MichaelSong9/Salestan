	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				width			: 500,											// Width of the progressbar - don't forget to adjust your image too!!!												// Image to use in the progressbar. Can be a single image too: '_shared/jQuery/ProgressBar/images/progressbg_green.gif'
				height			: 46,											// Height of the progressbar - don't forget to adjust your image too!!!
				callback		: null,											// Calls back with the config object that has the current percentage, target percentage, current image, etc
				boxImage		: '_shared/jQuery/ProgressBar/images/progress_over.png',						// boxImage : image around the progress bar
				barImage		: {
									0:	'_shared/jQuery/ProgressBar/images/progressbg_red.gif',
									30: '_shared/jQuery/ProgressBar/images/progressbg_orange.gif',
									70: '_shared/jQuery/ProgressBar/images/progressbg_green.gif'
								},
