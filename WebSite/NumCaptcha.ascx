...
<td valign="middle">&nbsp;&nbsp; =&nbsp;</td>
<td valign="middle">
<asp:TextBox ID="TextBoxNo" runat="server" width="25px" maxlength="2" CssClass="TextBoxRequiredL2R"></asp:TextBox>

<asp:RegularExpressionValidator ID="RegxNo" ControlToValidate="TextBoxNo" SetFocusOnError="true" Font-Size="11px" Display="Dynamic"
ValidationExpression="[0-9]{1,2}" runat="server" ErrorMessage="Enter Only Numerics"></asp:RegularExpressionValidator>
